...
const sqlQuery = `
INSERT INTO task_management.job_profiles (id, job_id, job_title, requested_by_id,job_type_id,job_req_comment,document_type_id,document_name,document_mode_id,requested_delivery_date,job_req_for,job_status,confidentiality,require_sample,require_edits,delivery_mode_id,deliver_to_id,deliver_to_department_id,deliver_to_location,require_cover,require_finishing_and_binding,job_requested_on,job_completed_on, createdAt, updatedAt)
SELECT t.id, t.jobID,t.jobTitle,t.jobReqBy,r1.id,t.jobReqComment,r2.id,t.jobDocName,r3.id,t.jobReqDeliveryDate,t.jobReqFor,r4.id,t.jobConfidential,t.jobReqSample,t.jobReqEdit,r5.id,t.jobDeliverTo,r6.id,t.jobDelLocation,t.jobReqCover,t.jobReqBinding,t.jobReqDate,t.jobDoneDate,"2023-03-21","2023-03-21"
