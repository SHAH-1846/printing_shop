...
const sqlQuery = `
INSERT INTO task_management.print_covers (id, job_id, print_cover_operator_id, request_date, completed_date, print_cover_status_id, print_cover_material_id, print_cover_quantity, print_cover_sides, print_cover_color_id, require_lamination, print_cover_machine_id,createdAt,updatedAt)
...
INNER JOIN task_management.print_cover_statuses r1 ON t.printCover_status = r1.status
INNER JOIN task_management.print_cover_colors r2 ON t.printCover_color = r2.print_cover_color;
