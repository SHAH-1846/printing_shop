...
router.get('/print-pages-printers', setAccessControl('1'), printPagesController.fetchAllPrintPagesPrinters);

router.get('/print-pages-paper-types', setAccessControl('1'), printPagesController.fetchAllPrintPagesPaperTypes);
